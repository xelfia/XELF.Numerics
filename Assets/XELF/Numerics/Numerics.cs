...
namespace XELF.Experimental.Numerics {
	...
	public readonly struct I {
		...
		public static (R r, I j) operator +(R r, I j) => (r, j);
		public static (R r, I j) operator -(R r, I j) => (r, -j);
	}
	/// <summary>
	...
	public readonly struct DI {
		...
		public static (R r, DI j) operator +(R r, DI j) => (r, j);
		public static (R r, DI j) operator -(R r, DI j) => (r, -j);
	}
	/// <summary>
	...
	public readonly struct K {
		...
		public static (R r, K j) operator +(R r, K k) => (r, k);
		public static (R r, K j) operator -(R r, K k) => (r, -k);
	}
	/// <summary>
	...
	public readonly struct DK {
		...
		public static (R r, DK j) operator +(R r, DK k) => (r, k);
		public static (R r, DK j) operator -(R r, DK k) => (r, -k);
	}
	/// <summary>
	/// w + dε
	...
	public readonly struct RD {
		...
		public RD(R r) { this.r = r; d = 0; }
		public RD(D d) { r = 0; this.d = d; }
		public RD(R r, D d) { this.r = r; this.d = d; }
	...
	public readonly struct IJK {
		...
		public IJK(I x, J y, K z) { this.i = x; this.j = y; this.k = z; }
	...
	public readonly struct RIJK {
		...
		public RIJK(R w, I x, J y, K z) { this.r = w; this.i = x; this.j = y; this.k = z; }
		public RIJK(I x, J y, K z, R w) { this.r = w; this.i = x; this.j = y; this.k = z; }
		public RIJK Normalized => ReciprocalLength * (RIJK)(r, i, j, k);
		public R LengthSquared => r * r - i * i - j * j - k * k;
		public R Length => Sqrt(LengthSquared.w);
		public R ReciprocalLength => 1 / Length;
